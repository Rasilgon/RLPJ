...
file.co2<-"/Users/RGonzalez/RamiroWork/lpjRun/crudata/co2_1901-2013_FAKE.txt"
file.cru <- "/Users/RGonzalez/RamiroWork/lpjRun/crudata/cru_1901_2006.bin"
file.cru.misc <- "/Users/RGonzalez/RamiroWork/lpjRun/crudata/cru_1901_2006misc.bin"
file.ndep <- "/Users/RGonzalez/RamiroWork/lpjRun/crudata/GlobalNitrogenDeposition.bin"

# if you are using the global_cf.ins file you neet to specify the site specific input files as well
file.temp <- "/Users/RGonzalez/RamiroWork/lpjRun/inputLPJ/temp.nc"
file.prec <- "/Users/RGonzalez/RamiroWork/lpjRun/inputLPJ/prec.nc"
file.insol <- "/Users/RGonzalez/RamiroWork/lpjRun/inputLPJ/rad.nc"
mainDir <- "/Users/RGonzalez/RamiroWork/lpjRun"
...
mySetup  <- setupLPJParallel(numCores = 3, clusterType ="SOCK", mainDir = "/Users/RGonzalez/RamiroWork/lpjRun")
